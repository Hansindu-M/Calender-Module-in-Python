#pyhton code to print calender
#without use of calender module

mm = int(input("Enter Month:"))
yy = int(input("Enter Year:"))

month = {1:'January', 2:'February', 3:'March', 4:'Aprl', 5:'May',6:'June', 7:'July',8:'August',9:'September',10:'October',
...
space = ''
space = space.rjust(2,'*')
#code below is to print the calender
